 ...
 * pickup date. It also knows how to calculate the total based on the order details.
 */
class OrderViewModel: ViewModel() {
    ...
    val price: LiveData<String> = Transformations.map(_price) {
        // Format price into local currency and return this as LiveData<String>
    ...
    private fun getPickupOptions(): List<String> {
        ...
        // Create a list of dates starting with the current date and following 3 dates
        repeat(4) {
